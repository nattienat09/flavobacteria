...
//Note to self: add rigid body option and flexible body option (this is the flexible body option and for the rigid body make new geometry one rectangle with 2 nodes on the 2 ends)
